...
const PendingInvestments = () => {
    ...
    const fetchPendingInvestments = async () => {
        try {
            const response = await fetch('https://jizbankplc.com/api/get_pending_investments.php');
    ...
    const approveInvestment = async (id, userId, amount) => {
      ...
      try {
        const res = await fetch('https://jizbankplc.com/api/approve_investment.php', {
          method: 'POST',
    ...
    const notifyUserInvestmentApproved = async (id, userId, amount) => {
      try {
        ...
        const response = await fetch('https://jizbankplc.com/api/notify_user_investment_approved.php', {
          method: 'POST',
          headers: {
    ...
    const handlePayCommission = async (investmentId) => {
      ...
      try {
        const response = await axios.post('https://jizbankplc.com/api/pay_commission.php', {
          id: investmentId
        });
    ...
    const deleteInvestment = async (investmentId, userId, amount) => {
      ...
      try {
        const response = await fetch('https://jizbankplc.com/api/delete_investment.php', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
    ...
    const handleNotify = async (userId, amount) => {
      ...
      try {
        ...
        const response = await fetch('https://jizbankplc.com/api/notify_user_investment_declined.php', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
