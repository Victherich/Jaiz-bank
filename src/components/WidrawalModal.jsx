...
const WithdrawalModal = ({ isOpen, onClose, userInfo, fetchTransactions }) => {
    ...
    const handleWithdraw = async () => {
      ...
      try {
        ...
        const response = await axios.post('https://jizbankplc.com/api/submit_withdrawal.php', {
          user_id: userInfo.id,
          name: userInfo.name,
    ...
    const notifyAdminWithdrawalRequest = async () => {
      try {
        ...
        const response = await fetch('https://jizbankplc.com/api/notify_admin_withdrawal.php', {
          method: 'POST',
          headers: {
